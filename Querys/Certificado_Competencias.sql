...
SELECT SMBPOGN_COLL_CODE, SMBAOGN_PROGRAM, SMBAOGN_TERM_CODE_EFF, SMBPOGN_CAMP_CODE, SMBAOGN_PIDM, SPRIDEN_ID, SPRIDEN_LAST_NAME ||', '|| SPRIDEN_FIRST_NAME AS ESTUDIANTE
	...
	, SMRACAA_RULE ||' - '|| SCBCRSE_TITLE AS CURSO_CERTIFICACION, SMRDOUS_SUBJ_CODE || SMRDOUS_CRSE_NUMB ||' - '|| SMRDOUS_TITLE AS CURSO_APROBADO
	, CASE 
