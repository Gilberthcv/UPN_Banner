...
FROM TBRACCD
WHERE TBRACCD_PIDM = GB_COMMON.F_GET_PIDM('N00072044')  --ID
    AND TBRACCD_TRAN_NUMBER IN (36,37);
...
WHERE TBRACCD_PAYMENT_ID IS NULL
    AND TBRACCD_ENTRY_DATE BETWEEN TO_DATE('17/08/2020','DD/MM/YYYY') AND SYSDATE
